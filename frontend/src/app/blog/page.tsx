...
export const metadata: Metadata = {
  title: 'Blog | Qyro — Arena Tips, Battle Guides & Platform Updates',
  description:
    'Read the Qyro blog for competitive learning tips, quiz strategies, ELO ranking guides, and platform announcements.',
  alternates: { canonical: 'https://samarpan-quiz.vercel.app/blog' },
  openGraph: {
    title: 'Qyro Blog',
    description: 'Battle tips, ELO strategy, and study guides from the Qyro team.',
    type: 'website',
  },
};
...
const POSTS = [
  {
    ...
    title: 'How ELO Ranking Works in Qyro Arena',
    excerpt:
  ...
  },
  {
    ...
    title: "Qyro's Anti-Cheat System Explained",
    excerpt:
  ...
  },
  {
    ...
    excerpt:
      'How BTech students are using Qyro to create topic-specific GATE practice quizzes, track weak areas via analytics, and compete on leaderboards.',
...
const CATEGORY_COLORS: Record<string, string> = {
  Guide:       'bg-red-500/10 text-red-400 border-red-500/20',
  'How-to':    'bg-[#00D4B4]/10 text-[#00D4B4] border-[#00D4B4]/20',
  Tutorial:    'bg-amber-500/10 text-amber-400 border-amber-500/20',
  Technical:   'bg-[#7B61FF]/10 text-[#7B61FF] border-[#7B61FF]/20',
  'Study Guide': 'bg-[#FFB800]/10 text-[#FFB800] border-[#FFB800]/20',
};
    ...
    <div className="min-h-screen bg-[#0D0D0D] text-white">
      ...
      <div className="border-b border-white/5 py-16 px-6">
        <div className="max-w-5xl mx-auto text-center space-y-4">
          <span className="text-xs uppercase tracking-widest font-black text-red-400 border border-red-500/20 bg-red-500/10 px-4 py-1.5 rounded-full inline-block">
            Qyro Blog
          </span>
          ...
          <p className="text-white/50 text-lg max-w-2xl mx-auto">
            Battle strategies, platform guides, ELO deep-dives, and study tips from the Qyro team.
          </p>
        </div>
      </div>
      ...
      <div className="max-w-5xl mx-auto px-6 py-16 space-y-16">
        ...
        {featured && (
          <section>
            ...
            <Link href={`/blog/${featured.slug}`} className="block group">
              <div className="rounded-[32px] border border-red-500/20 bg-gradient-to-br from-red-500/10 via-transparent to-transparent p-10 hover:border-red-500/40 transition-all">
                ...
                <h2 className="text-2xl lg:text-3xl font-black tracking-tight mb-3 group-hover:text-red-300 transition-colors">
                  {featured.title}
                </h2>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className="flex items-center gap-1 text-red-400 font-black text-sm group-hover:gap-2 transition-all">
              ...
              <Link key={post.slug} href={`/blog/${post.slug}`} className="block group">
                <article className="h-full rounded-[24px] border border-white/5 bg-white/[0.02] p-8 hover:border-white/10 hover:bg-white/[0.04] transition-all flex flex-col gap-4">
                  ...
                  <div className="flex-1">
                    <h3 className="font-black text-lg leading-tight mb-2 group-hover:text-red-300 transition-colors">
                      {post.title}
                    </h3>
                  ...
                  <div className="flex items-center justify-between pt-4 border-t border-white/5">
                    ...
                    <span className="text-[11px] font-black text-red-400 flex items-center gap-1 group-hover:gap-2 transition-all">
        ...
        {/* CTA */}
        <section className="rounded-[32px] border border-white/5 bg-gradient-to-r from-red-500/5 to-transparent p-10 text-center space-y-4">
          <h3 className="text-2xl font-black">Ready to dominate?</h3>
          <p className="text-white/50">Forge your first AI quiz in 2 seconds — free forever for students.</p>
          <Link href="/auth?mode=signup" className="inline-flex items-center gap-2 px-8 py-4 rounded-2xl bg-[#CC0000] text-white font-black hover:opacity-90 transition-all shadow-lg shadow-red-600/20">
