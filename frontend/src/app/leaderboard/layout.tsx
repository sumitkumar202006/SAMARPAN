...
export const metadata: Metadata = {
  title: 'Global Leaderboard | Top ELO Rankings — Samarpan Arena',
  description:
    'See the top-ranked players on Samarpan Arena. Filter by weekly, monthly, or all-time standings across subjects like CS, Maths, Science, History, and Geography.',
  alternates: {
    canonical: 'https://samarpan-quiz.vercel.app/leaderboard',
  },
  openGraph: {
    title: 'Global Leaderboard | Samarpan Arena',
