...
export const metadata: Metadata = {
  title: 'Terms of Service | Samarpan Arena',
  description: 'Terms of Service for Samarpan Arena — AI-powered live quiz platform.',
      ...
      <div className="max-w-3xl mx-auto px-6 py-20">
        ...
        <div className="prose prose-invert max-w-none space-y-10 text-white/70 leading-relaxed">
          ...
          <section>
            ...
            <p>By accessing or using Samarpan Arena (&quot;the Platform&quot;, &quot;we&quot;, &quot;us&quot;) at samarpan-quiz.vercel.app, you agree to be bound by these Terms of Service. If you do not agree to these terms, please do not use the Platform.</p>
          </section>

          <section>
            <h2 className="text-xl font-black text-white mb-3">2. Description of Service</h2>
            <p>Samarpan Arena is an AI-powered live quiz platform that allows users to:</p>
          ...
          <section>
            ...
            <p>Samarpan Arena offers free and paid subscription plans. Paid plans are processed via Razorpay and are subject to the following:</p>
            <ul className="list-disc pl-6 mt-2 space-y-1">
              ...
              <li><strong className="text-white">Refunds:</strong> See our <Link href="/refund" className="text-indigo-400 hover:text-indigo-300 underline">Refund Policy</Link>.</li>
            </ul>
          </section>

          <section>
            <h2 className="text-xl font-black text-white mb-3">5. Content and Intellectual Property</h2>
            <p>AI-generated quiz content is provided as-is and may contain errors. Samarpan Arena does not guarantee the accuracy of AI-generated questions. User-uploaded content (quizzes, PDFs) remains the property of the uploader. By publishing content to the Marketplace, you grant Samarpan Arena a non-exclusive license to display and distribute that content on the Platform.</p>
          </section>
          ...
          <section>
            ...
            <p>The Platform is provided &quot;as is&quot; without warranties of any kind. We do not guarantee uninterrupted or error-free service. Samarpan Arena is not liable for any loss of data, ELO rating, or subscription access due to technical failures.</p>
          </section>
